...
class LayoutManager final {
  public:
    ...
    [[nodiscard]] static utils::Result<domain::LayoutPreset> preset(const QString& presetId);
    ...
    [[nodiscard]] static utils::Result<void> changePreset(domain::SlotLayoutState& layout, const QString& presetId);
    [[nodiscard]] static utils::Result<void> assignToSlot(domain::SlotLayoutState& layout, const QString& sessionId, int slotIndex);
