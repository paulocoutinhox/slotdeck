...
class WebServerPlugin final : public QObject, public PluginInterface {
  ...
  public:
    ...
    [[nodiscard]] QFuture<utils::Result<void>> configureAndStartWebServer(const QString& serverId, const QString& name, const QString& root, const QString& host, int port, const QString& terminalId = {});
    [[nodiscard]] QFuture<utils::Result<void>> startWebServer(const QString& serverId);
    [[nodiscard]] QFuture<utils::Result<void>> removeWebServer(const QString& serverId);
  ...
  private:
    ...
    [[nodiscard]] QFuture<utils::Result<void>> startConfiguredWebServer(const QString& serverId);
    [[nodiscard]] QFuture<utils::Result<void>> startRuntime(const QString& serverId);
    [[nodiscard]] QFuture<utils::Result<void>> persistConfiguration(const QString& serverId);
    [[nodiscard]] utils::Result<void> startFailure(const QString& message, const QString& detail = {});
    ...
    QVector<QFuture<utils::Result<QString>>> m_rootValidationFutures;
