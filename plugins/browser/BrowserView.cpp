...
BrowserView::BrowserView(BrowserPlugin& plugin, QWidget* parent) : QWidget(parent), m_plugin(plugin) {
    ...
    m_back = ui::toolButton(ui::IconName::Back, m_plugin.host().theme(), m_plugin.host().translate(QStringLiteral("browser.actions.back")), toolbar);
    m_forward = ui::toolButton(ui::IconName::Forward, m_plugin.host().theme(), m_plugin.host().translate(QStringLiteral("browser.actions.forward")), toolbar);
    m_reload = ui::toolButton(ui::IconName::Refresh, m_plugin.host().theme(), m_plugin.host().translate(QStringLiteral("browser.actions.reload")), toolbar);
    m_stop = ui::toolButton(ui::IconName::Stop, m_plugin.host().theme(), m_plugin.host().translate(QStringLiteral("browser.actions.stop")), toolbar);
    auto* home = ui::toolButton(ui::IconName::Home, m_plugin.host().theme(), m_plugin.host().translate(QStringLiteral("browser.actions.home")), toolbar);
    auto* showBookmarks = ui::toolButton(ui::IconName::Bookmark, m_plugin.host().theme(), m_plugin.host().translate(QStringLiteral("browser.bookmarks.toggle")), toolbar);
    auto* add = ui::toolButton(ui::IconName::Add, m_plugin.host().theme(), m_plugin.host().translate(QStringLiteral("browser.actions.new-tab")), toolbar);
    ...
    emptyLayout->addWidget(ui::emptyStateLabel(m_plugin.host().translate(QStringLiteral("browser.tabs.empty")), m_empty));
    auto* createFirstTab = new QPushButton(ui::primaryIcon(ui::IconName::Add, m_plugin.host().theme()), m_plugin.host().translate(QStringLiteral("browser.actions.new-tab")), m_empty);
