...
QWidget* AiTaskDialog::createGeneralPage() {
    ...
    ui::sortComboBoxItems(m_executionKind);
    ...
    auto* browse = ui::toolButton(ui::IconName::Folder, m_host.theme(), m_host.translate(QStringLiteral("ai.task.choose-workdir")), page);
    ...
    m_executionForm->addRow(m_host.translate(QStringLiteral("ai.task.command-timeout")), ui::stepperRow(m_commandTimeout, m_host.theme(), page));
    ...
    layout->addWidget(ui::sectionTitleLabel(m_host.translate(QStringLiteral("ai.task.schedule")), page));
    ...
    m_scheduleForm->addRow(m_host.translate(QStringLiteral("ai.schedule.once")), ui::stepperRow(m_scheduleAt, m_host.theme(), page));
    m_scheduleForm->addRow(m_host.translate(QStringLiteral("ai.schedule.interval")), ui::stepperRow(m_scheduleInterval, m_host.theme(), page));
...
QWidget* AiTaskDialog::createPromptPage() {
    ...
    layout->addWidget(ui::sectionTitleLabel(m_host.translate(QStringLiteral("ai.task.prompt")), page));
