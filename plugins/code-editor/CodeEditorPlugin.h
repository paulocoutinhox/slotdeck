...
class CodeEditorPlugin final : public QObject, public PluginInterface {
  ...
  public:
    ...
    [[nodiscard]] utils::Result<QString> openWorkspace(const QString& rootPath);
    [[nodiscard]] utils::Result<void> closeWorkspace(const QString& workspaceId);
    [[nodiscard]] utils::Result<void> activateWorkspace(const QString& workspaceId);
    [[nodiscard]] utils::Result<void> moveWorkspace(int from, int to);
    [[nodiscard]] utils::Result<void> updateWorkspace(CodeWorkspaceState workspace);
