...
// Style sheets resolve theme values through named tokens so every surface reads the same source.
[[nodiscard]] QString applyThemeTokens(QString styleSheet, const Theme& theme);
...
class ThemeManager final {
  public:
    ...
    [[nodiscard]] utils::Result<void> selectTheme(const QString& themeId);
...
[[nodiscard]] ThemeManager& themeManager();
