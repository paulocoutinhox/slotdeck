...
QIcon icon(IconName name, const Theme& theme) {
    return QIcon(new IconEngine(name, theme.color(ThemeColor::TextMuted), theme.color(ThemeColor::Text)));
}

QIcon icon(IconName name, const QColor& color) {
    return QIcon(new IconEngine(name, color, color));
}

QIcon primaryIcon(IconName name, const Theme& theme) {
    return icon(name, theme.color(ThemeColor::OnAccent));
}
...
QIcon destructiveIcon(IconName name, const Theme& theme) {
    return icon(name, theme.color(ThemeColor::OnDanger));
}

QIcon layoutIcon(const QString& presetId, int columns, int rows, int slotCount, const Theme& theme) {
