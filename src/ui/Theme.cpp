...
QString GreenTheme::titleKey() const {
    return QStringLiteral("slotdeck.application.theme-green");
}
...
QString BlueTheme::titleKey() const {
    return QStringLiteral("slotdeck.application.theme-blue");
}
...
QString RedTheme::titleKey() const {
    return QStringLiteral("slotdeck.application.theme-red");
}
...
QString applyThemeTokens(QString styleSheet, const Theme& theme) {
