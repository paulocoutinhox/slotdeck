...
void TabWidget::applyTheme(const Theme& theme) {
    setStyleSheet(applyThemeTokens(QStringLiteral("QTabWidget::pane { border-width: 1px 0 0 0; border-style: solid; border-color: @border; border-radius: 0; background: transparent; }"), theme));
