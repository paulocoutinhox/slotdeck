...
class Toast final : public QFrame {
  public:
    ...
    void applyTheme(const Theme& theme) {
        ...
        m_icon->setPixmap(icon(ToastOverlayHelper::severityIcon(m_severity), accent).pixmap(18, 18));
        m_close->setIcon(icon(IconName::Close, theme.color(ThemeColor::TextMuted)));
