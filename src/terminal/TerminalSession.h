...
[[nodiscard]] std::unique_ptr<IPtyBackend> createSystemPtyBackend();
...
class TerminalSession final : public QObject {
  ...
  public:
    ...
    [[nodiscard]] utils::Result<void> start();
    [[nodiscard]] utils::Result<void> write(const QByteArray& bytes);
    [[nodiscard]] utils::Result<void> writeLocalPaths(const QStringList& paths);
    [[nodiscard]] utils::Result<void> sendKey(const QKeyEvent& event);
    [[nodiscard]] utils::Result<void> paste(const QByteArray& text);
    ...
    [[nodiscard]] utils::Result<void> sendMouse(const MouseReport& report);
    [[nodiscard]] utils::Result<void> sendFocus(bool gained);
